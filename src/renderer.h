...
public:
  Renderer()
      : m_pDevice(nullptr), m_pDeviceContext(nullptr), m_pSwapChain(nullptr),
        ...
        m_pInputLayout(nullptr), m_pGeomBuffer(nullptr),
        m_pSceneBuffer(nullptr), m_rotateModel(true), m_angle(0.0),
        m_prevUSec(0), m_rbPressed(false), m_prevMouseX(0), m_prevMouseY(0) {}
