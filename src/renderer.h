...
public:
  Renderer()
      : m_pDevice(nullptr), m_pDeviceContext(nullptr), m_pSwapChain(nullptr),
        m_pBackBufferRTV(nullptr), m_pDepthBuffer(nullptr),
        m_pDepthBufferDSV(nullptr), m_pDepthState(nullptr),
        m_pTransDepthState(nullptr), m_width(16), m_height(16),
        m_pGeomBuffer(nullptr), m_pGeomBuffer2(nullptr),
        m_pSceneBuffer(nullptr), m_pVertexBuffer(nullptr),
        m_pIndexBuffer(nullptr), m_pPixelShader(nullptr),
        m_pVertexShader(nullptr), m_pInputLayout(nullptr),
        m_pRectGeomBuffer(nullptr), m_pRectGeomBuffer2(nullptr),
        m_pRectVertexBuffer(nullptr), m_pRectIndexBuffer(nullptr),
        m_pRectPixelShader(nullptr), m_pRectVertexShader(nullptr),
        m_pRectInputLayout(nullptr), m_pSphereGeomBuffer(nullptr),
        ...
        m_pRasterizerState(nullptr), m_pTransBlendState(nullptr),
        m_pOpaqueBlendState(nullptr), m_prevUSec(0), m_rbPressed(false),
