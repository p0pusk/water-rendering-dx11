...
public:
  ...
  // p0SRV and p0UAV. The buffer resource referred by p1SRV and p1UAV is used as
  // intermediate result, and should be as large as the input/output buffer
  HRESULT ScanCS(ID3D11DeviceContext *pd3dImmediateContext,
                 ...
                 // SRV and UAV of an aux buffer, which must be the same size as
